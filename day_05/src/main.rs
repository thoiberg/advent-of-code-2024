...
fn main() {
    ...
    let (ordered, _) = partition_ordered(data);
...
fn partition_ordered((ordering_rules, updates): PrintQueue) -> (Vec<Vec<u32>>, Vec<Vec<u32>>) {
...
mod test_super {
    ...
    fn test_part_one_example() {
        let (ordered, _) = partition_ordered(test_data());
    ...
    fn test_part_one_solution() {
        let (ordered, _) =
            partition_ordered(process_input(include_str!("../data/puzzle_input.txt")));
